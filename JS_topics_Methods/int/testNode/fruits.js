// Write logic for following
// The list contains a total of eight even numbers of fruits and eight odd
// numbered fruits.

// --> Divide the list into pair(array) with even and odd number
// --> Give total number of fruit for both the even and odd number array
...
// const odd = oddFruits.reduce((total, curr)=>  total += curr.fruits, 0)
// console.log(odd);
